...
"dashboard_summary.png" is the static summary of the dashboard generated by the project. The image displays KPI indicators, bar charts by category/segment/region, a time‑series line chart and a scatter plot of discount vs profit margin. Opening `dashboard.html` provides an interactive version with hover tooltips and slicers.
